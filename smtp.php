...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        SMTP
        <small>Administra aqui el SMTP que envia los emails.</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        -------------------------->
		<object data="datagrid/smtp.php" type="text/html"  style="width:100%;height:600px;"></object>
		Te recomendamos crear una cuenta SMTP nueva para usar en mercury,
		<strong>NO DEBES USAR TU CORREO PERSONAL O EMPRESARIAL !</strong>
		Te recomendamos crear una cuenta nueva ya que la cuenta asociada no debe ser oficial webmail o gmail de tu negocio.
		<a href="https://www.mailgun.com/" target="_blank" class="txt3">
		Registrar un MAILGUN
		</a>
