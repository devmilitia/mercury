...
$consulta = "SELECT * FROM editores WHERE id='$body' ORDER BY id LIMIT 1";
$resultado = $conexion->query($consulta);
if($consulta->errno) die($consulta->error);
//Guardamos el registro en la variable $fila
$fila = $resultado->fetch_assoc();
...
echo "<font color='green'><br> $cont .<strong>Campaña enviada a: </strong>".$email."</font></br>";
