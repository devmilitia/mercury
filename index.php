...
<?php include('sidebarmenu.php');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Publicidad
        <small>Clic sobre el nombre de Plantilla para editar visualmente</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content container-fluid">
      ...
      <!--------------------------
        ...
        -------------------------->
		<object data="datagrid/newsletters.php" type="text/html" style="width:100%;height:500px;"></object>
