...
<?php echo base64_decode($row['contenido_grapesjs']) ?>
</div>
...
<?php
//nube free
$db = new mysqli($cfg_servidor,$cfg_usuario,$cfg_password,$cfg_basephp);
$resource = $db->query('SELECT url FROM nube WHERE 1');
$i=0;
    ...
    pluginsOpts: {
      ...
      cmdm.add('send-test', {
        run(editor, sender) {
          ...
          $.ajax({
                url: 'A_actualizar_newsletter.php',
                type: 'POST',
