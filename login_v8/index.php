...
if(isset($_POST[$form_names['user']], $_POST[$form_names['password']])) {
        ...
        if($csrf->check_valid('post')) {
				...
				$ssql = "SELECT * FROM admin WHERE usuario='$user' and clave='$password'";
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<input type="hidden" name="<?= $token_id; ?>" value="<?= $token_value; ?>" />
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate="Por favor ingresa un usuario">
						<input class="input100 validate[required,custom[email]] feedback-input" type="text" name="<?= $form_names['user']; ?>" placeholder="Usuario">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Por favor ingresa una contraseña">
						<input class="input100 validate[required,length[6,300]] feedback-input" type="password" name="<?= $form_names['password']; ?>" placeholder="Contraseña">
						<span class="focus-input100"></span>
					</div>
					<br>
